        ...
        <div className="grid lg:grid-cols-[1fr_1.4fr] gap-10 lg:gap-12 items-center">
          ...
          <div>
            <p className="text-sm sm:text-base text-muted-foreground mb-4">
              Primer Cherang Clinic Bertam Putra
            </p>
            ...
            <p className="text-base sm:text-lg text-muted-foreground mb-10 max-w-lg leading-relaxed text-justify">
              <strong className="text-foreground">
                Klinik Primer Cherang Bertam Putra
              </strong>
              , klinik perubatan mesra keluarga di Kepala Batas, Pulau Pinang, menawarkan
          ...
          <div className="relative">
            <div className="rounded-3xl overflow-hidden shadow-lg border border-border/50 relative">
              ...
              />
              {/* Doctor labels */}
              <span className="absolute bottom-[8%] left-[10%] bg-white/90 backdrop-blur-sm text-xs sm:text-sm font-semibold text-foreground px-3 py-1 rounded-full shadow-md">
                Dr. Adib
              </span>
              <span className="absolute bottom-[8%] right-[10%] bg-white/90 backdrop-blur-sm text-xs sm:text-sm font-semibold text-foreground px-3 py-1 rounded-full shadow-md">
                Dr. Norfazliana
              </span>
            </div>
          </div>
